...
$pageDescription = 'Ürün stoklarını görüntüleyin';
...
<script>
        ...
        categoryStats.forEach(cat => {
            html += `
                <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-md p-4 text-white">
                    ...
                    <div class="text-xs text-blue-100">${cat.product_count} ürün</div>
                </div>
            `;
        });
    ...
    function renderStockTable() {
        ...
        html += '<th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase">Ürün Adı</th>';
        html += '<th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase">Birim</th>';
        html += '<th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase">Kategori</th>';
        html += '<th class="px-6 py-3 text-right text-xs font-medium text-gray-700 uppercase">Toplam Stok</th>';
        html += '<th class="px-6 py-3 text-right text-xs font-medium text-gray-700 uppercase">Referans</th>';
        html += '<th class="px-6 py-3 text-center text-xs font-medium text-gray-700 uppercase">Durum</th>';
        html += '</tr></thead><tbody>';
